      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Kelola tugas Anda dengan efisien</p>
          </div>
        </div>
        <div class="flex items-center space-x-4">
          <div class="text-right">
            <p class="text-sm text-gray-600">Total Tugas</p>
            <p class="text-xl font-bold text-purple-600" id="totalTasks">{{ total }}</p>
          </div>
          <div class="text-right">
            <p class="text-sm text-gray-600">Selesai</p>
            <p class="text-xl font-bold text-green-600" id="completedTasks">{{ totalCompleted }}</p>
          </div>
        </div>
      </div>
    </div>
